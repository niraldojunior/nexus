...
const SP =
  'C:/Users/VT158145/AppData/Local/Temp/claude/c--Users-VT158145-workspace-nexus/b8cb02c2-61a6-4269-a27a-9d68ad293c8a/scratchpad';
...
const clicked = await firstResult
  ...
  .then(() => true)
  .catch((e) => {
    consoleMessages.push('result click failed: ' + e.message);
    return false;
  });
...
const panelOpened =
  bodyAfter.includes('Visão geral') ||
  bodyAfter.includes('Sub-locais') ||
  bodyAfter.includes('Sistema de origem');
console.log('---RESULT---');
