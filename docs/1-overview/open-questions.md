...
| ID | Questão | Estado | Responsável |
|---|---|---|---|
| **Q-ARQ-001** | Aprovar o esforço de converter as 5 interfaces de repositório para assíncronas (`Promise`). É pré-condição de escala. | 🔴 Aberta | Arquitetura + Engenharia |
