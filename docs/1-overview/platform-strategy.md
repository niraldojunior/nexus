...
| Núcleo hexagonal com interface de repositório isolada do adapter Oracle                      | Domínio isolado de infraestrutura por design — a mesma separação sustenta multi-tenant mesmo hoje com um único adapter | [`architecture.md`](../3-system-design/architecture.md) §3                                                                       |
