...
| 2   | **Resource**              | O que existe                            | TMF634, TMF639, TMF664 | ⚠️ Base implementada; aderência parcial ao HLD 1.10 (inclui detalhe agregado, Audit Trail, catálogo de estados granulares de PhysicalResource, estruturação relacional de especificações, portas de splitter no piloto Niterói/Icaraí e conexões físicas Porta→CaboDrop com faróis SID) |
