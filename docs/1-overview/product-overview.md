...
| --- | ------------------------- | --------------------------------------- | ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | **Geographic**            | Onde                                    | TMF673, TMF674, TMF675 | ⚠️ Base implementada; aderência parcial ao HLD 1.25 (inclui Cobertura GPON por bairro, consulta inversa/aba Cobertura por Resource, Projetos de Trabalho com Resources e o Painel Unificado de Local; `FunctionalGroup` foi descontinuada como categoria)                                                                                                                       |
| 2   | **Resource**              | O que existe                            | TMF634, TMF639, TMF664 | ⚠️ Base implementada; aderência ao HLD 1.14 (inclui catálogo em árvore dinâmica `ResourceCatalog`/`ResourceCatalogNode` com identidade agregada 1:1 folha↔ResourceType, catálogo governado de `ResourceRelationshipType` e regras permitidas `ResourceTypeRelationshipRule`, `ResourceSpecification` via FK `resourceTypeId` e com `relatedParty` de fabricante, `PhysicalResource` com vendor de aquisição, filtros de `relatedParty` no Oracle, detalhe agregado, Audit Trail, catálogo de estados granulares, portas de splitter no piloto Niterói/Icaraí e conexões físicas Porta→CaboDrop com faróis SID) |
