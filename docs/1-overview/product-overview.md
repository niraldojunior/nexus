...
| 2   | **Resource**              | O que existe                            | TMF634, TMF639, TMF664 | ⚠️ Base implementada; aderência parcial ao HLD 1.7 (inclui detalhe agregado, Audit Trail e catálogo de estados granulares de PhysicalResource)             |
