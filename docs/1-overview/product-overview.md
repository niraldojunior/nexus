...
| 2   | **Resource**              | O que existe                            | TMF634, TMF639, TMF664 | ⚠️ Base implementada; aderência parcial ao HLD 1.8 (inclui detalhe agregado, Audit Trail, catálogo de estados granulares de PhysicalResource e estruturação relacional de especificações)             |
