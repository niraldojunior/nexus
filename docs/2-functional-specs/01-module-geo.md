...
| **RF-006** | **Migração de Installation Point**      | Script dedicado migra sites de `INSTALLATION_POINT` para `CUSTOMER_SITE` sobre Oracle (C10), dry-run por padrão.                                       |
