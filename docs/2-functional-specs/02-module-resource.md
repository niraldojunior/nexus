...
| **REQ-MOD02-009** | Parcial          | CTO/Splitter são representáveis por catálogo, characteristics e relações genéricas.                                  | Portas, razão óptica, ocupação, cascata e validações OSP dedicadas.                                   | [#115](https://github.com/niraldojunior/nexus/issues/115)                                                            | [#143](https://github.com/niraldojunior/nexus/issues/143)                                                                                                                       |
