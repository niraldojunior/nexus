...
| **REQ-MOD02-024** | Divergente       | Relações têm CRUD, mas `ResourceService` aceita qualquer string; a tabela de catálogo não possui API de governança.  | Bootstrap + CRUD de RelationshipType, inversos, simetria, Audit e validação em writes.                | [#119](https://github.com/niraldojunior/nexus/issues/119)                                                            | [#147](https://github.com/niraldojunior/nexus/issues/147)                                                                                                                       |
