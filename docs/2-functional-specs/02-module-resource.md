...
| ----------------- | ---------------- | -------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **REQ-MOD02-001** | Parcial          | `ResourceService`, repositório Oracle, rotas TMF634, UI de catálogo e testes cobrem CRUD de ResourceSpecification; modelagem 1:1 folha↔ResourceType no Studio. | UUID v7/`_origin`, lifecycle completo, catálogo de characteristics e governança multi-tenant.         | [#112](https://github.com/niraldojunior/nexus/issues/112)                                                            | [#142](https://github.com/niraldojunior/nexus/issues/142), [#157](https://github.com/niraldojunior/nexus/issues/157), [#160](https://github.com/niraldojunior/nexus/issues/160), [#230](https://github.com/niraldojunior/nexus/issues/230) |
| **REQ-MOD02-002** | Parcial          | Árvore dinâmica `ResourceCatalog` / `ResourceCatalogNode` (`GROUP` e `RESOURCE_TYPE`) persistida no Oracle, com CRUD governado, autosave e publicação via Studio. | Hierarquia com profundidade arbitrária, versionamento de draft e materialização transacional entregues. | [#112](https://github.com/niraldojunior/nexus/issues/112)                                                            | [#142](https://github.com/niraldojunior/nexus/issues/142), [#188](https://github.com/niraldojunior/nexus/issues/188), [#230](https://github.com/niraldojunior/nexus/issues/230)                                                                                                                       |
...
| **REQ-MOD02-004** | Implementado     | `ResourceSpecification` possui `relatedParty` com role `manufacturer` gerenciável via Studio; `PhysicalResource` possui `relatedParty` com role `vendor` de aquisição e proteção contra `manufacturer` direto na instância; filtros de query `relatedPartyId` e `relatedPartyRole` ativos em TMF639/TMF634 contra Oracle. | —                                                                                                     | —                                                                                                                    | [#142](https://github.com/niraldojunior/nexus/issues/142), [#160](https://github.com/niraldojunior/nexus/issues/160), [#251](https://github.com/niraldojunior/nexus/issues/251) |
| **REQ-MOD02-005** | Parcial          | CRUD físico/lógico, filtros, paginação, workspace, place/Party e testes TMF639 estão ativos.                         | Bulk, histórico, características validadas, UUID v7 e `_origin`.                                      | —                                                                                                                    | [#143](https://github.com/niraldojunior/nexus/issues/143), [#157](https://github.com/niraldojunior/nexus/issues/157)                                                            |
| **REQ-MOD02-006** | Parcial          | Estados X.731 básicos, soft-delete e TMF664 são exercitados por testes.                                              | Matriz completa de transições, razões, histórico e concorrência.                                      | —                                                                                                                    | [#143](https://github.com/niraldojunior/nexus/issues/143)                                                                                                                       |
| **REQ-MOD02-007** | Parcial          | ResourceRelationship persiste contenção e o inventário expõe relações.                                               | Regras por Specification, ciclos, capacidade/slot e inversos governados.                              | [#119](https://github.com/niraldojunior/nexus/issues/119)                                                            | [#143](https://github.com/niraldojunior/nexus/issues/143), [#147](https://github.com/niraldojunior/nexus/issues/147)                                                            |
| **REQ-MOD02-008** | Parcial          | Support Structures são representáveis como PhysicalResource tipado e aparecem no viewport Geo.                       | Invariantes de poste/duto/manhole, owner/contrato, bulk GeoJSON e mapas específicos.                  | —                                                                                                                    | [#143](https://github.com/niraldojunior/nexus/issues/143)                                                                                                                       |
| **REQ-MOD02-009** | Parcial          | CTO/Splitter têm catálogo, relações, estado granular extensível e leitura agregada de detalhe/histórico; fabricante, modelo e topologia são resolvidos pela Specification. Porta (FO.I/FO.O) materializada como PhysicalResource contida no splitter, com aba dedicada no painel, agregação de portas via `GET /v1/resources/:ctoId/ports` e faróis SID/X.731 com ocupação derivada do grafo Resource — **limitado ao piloto Niterói/Icaraí** (`scripts/load-cto-ports.mjs`), cuja razão de divisão real é conhecida; a carga nacional Netwin não expõe a razão de divisão do splitter na origem, então não recebe porta ainda. | Materialização de portas em escala nacional (depende de importador direto do BD de DR do Netwin, que traga a razão óptica real — issue futura), cascata completa e validações OSP dedicadas. | [#115](https://github.com/niraldojunior/nexus/issues/115)                                                            | [#143](https://github.com/niraldojunior/nexus/issues/143), [#171](https://github.com/niraldojunior/nexus/issues/171), [#177](https://github.com/niraldojunior/nexus/issues/177)                                                            |
| **REQ-MOD02-010** | Parcial          | Cabos LineString podem ser carregados e exibidos no mapa Geo.                                                        | Segments/fibers, ocupação, continuidade, edição e importação geoespacial.                             | [#115](https://github.com/niraldojunior/nexus/issues/115)                                                            | [#143](https://github.com/niraldojunior/nexus/issues/143)                                                                                                                       |
| **REQ-MOD02-011** | Parcial          | Splice é representável por Resource/Relationship genéricos.                                                          | Entidade operacional, validação de fibras/atenuação e manutenção transacional.                        | [#115](https://github.com/niraldojunior/nexus/issues/115)                                                            | [#143](https://github.com/niraldojunior/nexus/issues/143)                                                                                                                       |
| **REQ-MOD02-012** | Não implementado | Não há rota nem serviço de path computation ainda.                                                                   | Path, raiz comum, métricas ópticas, visualização e cache em escala.                                   | [#117](https://github.com/niraldojunior/nexus/issues/117)                                                            | [#144](https://github.com/niraldojunior/nexus/issues/144), [#161](https://github.com/niraldojunior/nexus/issues/161)                                                            |
| **REQ-MOD02-013** | Parcial          | Rack é representável como PhysicalResource contido em Site.                                                          | Elevação em U, face, ocupação, potência e conflitos de posição.                                       | —                                                                                                                    | [#145](https://github.com/niraldojunior/nexus/issues/145)                                                                                                                       |
| **REQ-MOD02-014** | Parcial          | Equipment possui modelo/fabricante/serial, CRUD, UI e resolução por catálogo.                                        | Slots, funções, swap BPMN e regras específicas por classe.                                            | MOD05                                                                                                                | [#145](https://github.com/niraldojunior/nexus/issues/145)                                                                                                                       |
| **REQ-MOD02-015** | Parcial          | Card é representável por PhysicalResource e relação de contenção.                                                    | Compatibilidade de slot, capacidade e lifecycle dependente do chassis.                                | —                                                                                                                    | [#145](https://github.com/niraldojunior/nexus/issues/145)                                                                                                                       |
| **REQ-MOD02-016** | Parcial          | Port é representável por catálogo/ResourceRelationship; endpoint `GET /v1/resources/:portId/port-detail` projeta splitter pai, CTO continente, drops atuais/históricos e faróis SID/X.731 no painel empilhado sem chrome geográfico; ocupação física é derivada exclusivamente de `DropCable` conectado. | Tipo/direção/velocidade, ocupação exclusiva e terminação física para todos os tipos de porta Inside/Outside Plant. | —                                                                                                                    | [#145](https://github.com/niraldojunior/nexus/issues/145), [#177](https://github.com/niraldojunior/nexus/issues/177)                                                                                                                       |
| **REQ-MOD02-017** | Parcial          | Power resources podem ser cadastrados genericamente.                                                                 | Circuitos A/B, carga, capacidade, redundância e impacto de falha.                                     | [#118](https://github.com/niraldojunior/nexus/issues/118)                                                            | [#145](https://github.com/niraldojunior/nexus/issues/145)                                                                                                                       |
| **REQ-MOD02-018** | Parcial          | Relações `connectedTo` podem ligar Resources; conexões `Port(FO.O.n) → DropCable` aplicam exclusividade de 1 drop ativo no write e ocupação derivada bidirecional no Resource inventory. | Endpoints tipados, simetria, exclusividade e continuidade física para demais tipos de conexão física. | [#119](https://github.com/niraldojunior/nexus/issues/119)                                                            | [#145](https://github.com/niraldojunior/nexus/issues/145), [#147](https://github.com/niraldojunior/nexus/issues/147), [#177](https://github.com/niraldojunior/nexus/issues/177)                                                            |
| **REQ-MOD02-019** | Parcial          | Front/Rear Port são representáveis por tipos e `mirrorOf`.                                                           | Pareamento obrigatório, passagem interna e validação de DIO/DG.                                       | —                                                                                                                    | [#145](https://github.com/niraldojunior/nexus/issues/145)                                                                                                                       |
| **REQ-MOD02-020** | Parcial          | Prefix/IP/Range podem ser LogicalResources e a UI suporta inventário lógico.                                         | Alocação IPAM, sobreposição, hierarquia de prefixos e reserva concorrente.                            | [#116](https://github.com/niraldojunior/nexus/issues/116)                                                            | [#146](https://github.com/niraldojunior/nexus/issues/146)                                                                                                                       |
| **REQ-MOD02-021** | Parcial          | VRF e RouteTarget são representáveis por LogicalResource/characteristics.                                            | Unicidade de RD/RT, membership, import/export e consultas específicas.                                | [#116](https://github.com/niraldojunior/nexus/issues/116)                                                            | [#146](https://github.com/niraldojunior/nexus/issues/146)                                                                                                                       |
| **REQ-MOD02-022** | Parcial          | VLAN/VLAN Group são representáveis pelo inventário lógico.                                                           | Faixas, escopo, alocação, conflitos e vínculo a portas/serviços.                                      | [#116](https://github.com/niraldojunior/nexus/issues/116)                                                            | [#146](https://github.com/niraldojunior/nexus/issues/146)                                                                                                                       |
| **REQ-MOD02-023** | Parcial          | ASN/MPLS Label são representáveis por LogicalResource.                                                               | Pools, alocação, unicidade, escopo e lifecycle próprios.                                              | [#116](https://github.com/niraldojunior/nexus/issues/116)                                                            | [#146](https://github.com/niraldojunior/nexus/issues/146)                                                                                                                       |
| **REQ-MOD02-024** | Parcial          | Catálogo `ResourceRelationshipType` governado no Oracle com bootstrap e API `/v1/resource/relationship-types`; regras permitidas por tipo via `ResourceTypeRelationshipRule` em `/v1/resource-types/:id/relationship-rules`. | Validação de regras em tempo de criação de instância de recurso (`ResourceRelationship`) e inverso automático em writes. | [#119](https://github.com/niraldojunior/nexus/issues/119)                                                            | [#147](https://github.com/niraldojunior/nexus/issues/147), [#230](https://github.com/niraldojunior/nexus/issues/230)                                                                                                                       |
| **REQ-MOD02-025** | Parcial          | Eventos de catálogo/inventário são persistidos em `tmf_event`, expostos via TMF688 e testados.                       | Outbox, Schema Registry, catálogo público, DLQ, reprocessamento e UUID v7.                            | —                                                                                                                    | [#158](https://github.com/niraldojunior/nexus/issues/158)                                                                                                                       |
| **REQ-MOD02-026** | Não implementado | Duto existe apenas como Support Structure plana, com capacidade e ocupação digitadas em characteristics.             | Contenção banco→duto→sub-duto→cabo, endpoints A/Z obrigatórios, trecho derivado e ocupação calculada. | [#121](https://github.com/niraldojunior/nexus/issues/121)                                                            | [#148](https://github.com/niraldojunior/nexus/issues/148), [#143](https://github.com/niraldojunior/nexus/issues/143)                                                            |
| **REQ-MOD02-027** | Não implementado | Só existem validações de escrita; nenhuma rotina varre a base já carregada por script ou migração.                   | Catálogo de regras por API, varredura agendada, findings com ciclo de vida, score e evento TMF688.    | —                                                                                                                    | [#149](https://github.com/niraldojunior/nexus/issues/149), [#158](https://github.com/niraldojunior/nexus/issues/158)                                                            |
| **REQ-MOD02-028** | Não implementado | Criar recurso composto exige uma chamada por objeto; a Specification não declara composição.                         | `childTemplate[]`, materialização transacional, pré-visualização e import em massa idempotente.       | [#112](https://github.com/niraldojunior/nexus/issues/112)                                                            | [#150](https://github.com/niraldojunior/nexus/issues/150), [#142](https://github.com/niraldojunior/nexus/issues/142)                                                            |
...
O tipo funcional, fabricante, modelo e topologia exibidos para o recurso são propriedades de catálogo: vêm da `ResourceSpecification` e de suas `resourceSpecificationCharacteristic` (como a characteristic canônica `model`), e seu fabricante da `relatedParty` da especificação com `role='manufacturer'`, não de colunas copiadas na instância (as colunas legadas `manufacturer` e `model` em `tmf_physical_resource` foram completamente removidas do schema físico). Instâncias podem ter `relatedParty` com `role='vendor'` para representar o fornecedor de aquisição da unidade (RN-002).

O lifecycle combina dois níveis ortogonais: os eixos SID/X.731 (`status`, `administrativeState`, `operationalState`, `usageState`) descrevem a condição canônica; `statusCode` referencia o catálogo extensível de motivo granular, como `blocked_risk_area` — “Bloqueado por área de risco”. O texto original da origem pode permanecer em characteristic para rastreabilidade, mas não é a fonte governada do estado granular.

A leitura operacional agregada do Nexus expõe `GET /v1/resources/{id}/detail` e `GET /v1/resources/{id}/audit`. São projeções não-TMF para o painel: o primeiro resolve Specification, motivo granular, pai, `place`, estação abastecedora, projeto e contagem de filhos; o segundo lê snapshots `before`/`after` do Audit Trail existente, sem duplicar o modelo TMF639.
...
| **RF-010** | **Estado granular governado**   | `statusCode` referencia catálogo extensível e tipado por ResourceType, separado dos eixos SID/X.731; cargas legadas preservam o texto original para rastreabilidade. |
| **RF-011** | **Detalhe operacional agregado** | `GET /v1/resources/{id}/detail` resolve Specification, motivo granular, relações e referências geográficas/projeto para consumo do painel sem persistir uma nova entidade; `GET /v1/resources/{ctoId}/ports` agrega os grupos de splitter e portas com ocupação derivada do grafo físico. |
| **RF-012** | **Histórico auditável**         | `GET /v1/resources/{id}/audit` lista mutações com data, ator e snapshots `before`/`after`; recursos carregados diretamente por SQL podem não possuir histórico retroativo. |
| **RF-013** | **Projeção de portas de CTO**   | A aba Portas da CTO consome visão agregada em uma chamada HTTP, com faróis SID/X.731 para cada porta e distinção de drop ativo/histórico. |
...
| **CA-007** | **Motivo granular**       | CTO com substatus legado de área de risco resolve `statusCode=blocked_risk_area` e nome “Bloqueado por área de risco”, sem alterar o eixo SID. |
| **CA-008** | **Fonte de catálogo**     | O detalhe de CTO devolve tipo, fabricante, modelo e topologia da ResourceSpecification; valores da instância são apenas fallback de migração. |
| **CA-009** | **Histórico before/after** | Após atualização do recurso, a consulta de audit devolve os snapshots anterior e posterior; ausência de entradas para carga SQL direta resulta em lista vazia. |
| **CA-010** | **Ocupação física de splitter** | GET `/v1/resources/{ctoId}/ports` retorna FO.I preservando seu estado persistido e FO.O com ocupação derivada exclusivamente da presença de DropCable conectado via `connectedTo`. |
...
| **CA-006** | **Performance**      | Path típico de 8 saltos resolvido em < 500ms (95p) via SQL recursivo, com cache; a validar por benchmark.                                             |
...
| Capacidade                          | Netwin                           | Kuwaiba                          | NetBox                           | Decisão Nexus                           |
| ----------------------------------- | -------------------------------- | -------------------------------- | -------------------------------- | --------------------------------------- |
| **Path computation fim-a-fim**      | Limitada                         | Sim (nativo do grafo)            | Limitada a circuits              | **Sim — SQL recursivo portável**        |
...
| **Performance em escala**           | Adequada para escala atual       | Limitada (Neo4j embarcado)       | Não identificado no levantamento | **SQL recursivo + cache, a validar para 22M+ HPs** |
...
| **RF-009** | **Painel especializado de Porta** | `GET /v1/resources/{portId}/port-detail` expõe papel funcional (FO.I/FO.O), splitter pai, CTO continente, drops atuais e históricos para painel sem chrome geográfico. |
...
| **RN-006** | Porta de saída de splitter (`FO.O`) aceita no máximo um `DropCable` ativo simultaneamente via `connectedTo`. |
...
| **CA-006** | **Detalhe de porta de splitter** | GET `/v1/resources/{portId}/port-detail` retorna splitter pai, CTO, splitRatio, drops conectados e usageState derivado. |
...
| **RF-009** | **Exclusividade de Drop em Splitter** | Criação de `connectedTo` entre `Port(FO.O)` e `DropCable` valida e impede segundo drop ativo. |
...
| **CA-006** | **Exclusividade de drop ativo** | Criar segundo `connectedTo` ativo entre a mesma `Port(FO.O)` e outro `DropCable` retorna 409 (`RESOURCE_PORT_DROP_OCCUPIED`). |
...
| **RF-006** | **Grafo**                          | Suporte a queries de grafo via SQL recursivo portável (CTE recursiva / `CONNECT BY`): pathBetween(a,b), descendants(a), connectedComponent(a).                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| **Grafo nativo**                | Não identificado no levantamento | Sim                       | Limitado                         | **SQL recursivo portável sobre o relacional**     |
...
`tipo:decisão` e `mod:resource`:
[github.com/niraldojunior/nexus/issues?q=is:open+label:mod:resource](https://github.com/niraldojunior/nexus/issues?q=is%3Aopen+label%3Amod%3Aresource).
...
| 1.4    | Agosto 2026 | Produto — V.tal Nexus    | Incorporação da consulta operacional de OSP (`inspirations/geosite-legado.md`): princípios 4.8 a 4.11; novos REQ-MOD02-026 (banco de dutos, duto, sub-duto e trecho derivado), REQ-MOD02-027 (integridade e completude) e REQ-MOD02-028 (cadastro composto por template); grupo `_asset` em REQ-MOD02-005; trajeto de infraestrutura em REQ-MOD02-010; trajeto civil e impacto reverso em REQ-MOD02-012; [#120](https://github.com/niraldojunior/nexus/issues/120) e [#121](https://github.com/niraldojunior/nexus/issues/121); backlog [#148](https://github.com/niraldojunior/nexus/issues/148) a [#150](https://github.com/niraldojunior/nexus/issues/150). |
| 1.5    | Agosto 2026 | Engenharia — V.tal Nexus | Migração do backlog documental para GitHub Issues: questões (`Q-RES-*`) e lacunas (`DEV-RES-*`/`DEV-X-*`) passam a ser rastreadas por issue, com labels `tipo:decisão`/`tipo:lacuna` e `mod:resource`. §37 aponta para o filtro de issues em vez de tabela local.                                                                                                                                                                                                                                                                                                                                                                                              |
| 1.6    | Agosto 2026 | Engenharia — V.tal Nexus | Remoção de Property Graph do desenho de path computation (§4.4, RF-006, CA-006, REQ-MOD02-012): verificação contra a instância Oracle real (19c EE) mostrou que `CREATE PROPERTY GRAPH` não é suportado; a técnica passa a ser SQL recursivo portável (CTE recursiva / `CONNECT BY`), conforme C10. Referências a Neon Postgres substituídas por PostgreSQL.                                                                                                                                                                                                                                                                                                              |
| 1.7    | Agosto 2026 | Engenharia — V.tal Nexus | Convergência inicial do painel e modelo de PhysicalResource ([#171](https://github.com/niraldojunior/nexus/issues/171)): catálogo extensível de estados granulares separado dos eixos SID/X.731; tipo e atributos de produto resolvidos pela ResourceSpecification; projeções de detalhe e Audit Trail para o painel; novos campos de etiqueta física, referência de ativo e projeto. Portas materializadas e demais especializações da CTO permanecem como fases posteriores. |
