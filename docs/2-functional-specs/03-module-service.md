...
| ----------------- | ---------- | ------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| **REQ-MOD03-001** | Parcial    | CRUD de ServiceSpecification, filtros, workspace, frontend e testes estão ativos.                 | Lifecycle/versionamento completos, characteristics governadas, UUID v7 e `_origin`.                                              | [#122](https://github.com/niraldojunior/nexus/issues/122)                                                            | [#151](https://github.com/niraldojunior/nexus/issues/151), [#157](https://github.com/niraldojunior/nexus/issues/157) |
| **REQ-MOD03-002** | Parcial    | ServiceCategory tem CRUD, parent ref, filtros e persistência.                                     | Árvore expandida, raiz única, ordenação e governança multi-tenant.                                                               | [#122](https://github.com/niraldojunior/nexus/issues/122)                                                            | [#151](https://github.com/niraldojunior/nexus/issues/151), [#160](https://github.com/niraldojunior/nexus/issues/160) |
| **REQ-MOD03-003** | Parcial    | ServiceCandidate tem CRUD, filtros por spec/categoria/status e eventos.                           | Regras de publicação, vigência, associação comercial e visibilidade por tenant.                                                  | [#122](https://github.com/niraldojunior/nexus/issues/122)                                                            | [#151](https://github.com/niraldojunior/nexus/issues/151), [#160](https://github.com/niraldojunior/nexus/issues/160) |
| **REQ-MOD03-004** | Parcial    | CRUD CFS/RFS, filtros, paginação, workspace, UI e MCP são cobertos por testes.                    | Bulk, expansão `fields`, histórico, UUID v7 e `_origin`.                                                                         | —                                                                                                                    | [#152](https://github.com/niraldojunior/nexus/issues/152), [#157](https://github.com/niraldojunior/nexus/issues/157) |
| **REQ-MOD03-005** | Parcial    | Estados válidos, PATCH, soft-terminate e eventos estão implementados.                             | Máquina de transições, razões, propagação e histórico semântico.                                                                 | [#126](https://github.com/niraldojunior/nexus/issues/126)                                                            | [#152](https://github.com/niraldojunior/nexus/issues/152), [#154](https://github.com/niraldojunior/nexus/issues/154) |
| **REQ-MOD03-006** | Parcial    | CFS exige SubscriberID e RFS suportante; código/UI/MCP proíbem `supportingResource` direto.       | Política completa de Tenant, unicidade e reconciliação do subscriber.                                                            | [#123](https://github.com/niraldojunior/nexus/issues/123)                                                            | [#153](https://github.com/niraldojunior/nexus/issues/153), [#160](https://github.com/niraldojunior/nexus/issues/160) |
| **REQ-MOD03-007** | Parcial    | RFS exige Resource existente e pode compor outros RFS.                                            | Invariantes técnicas, compartilhamento/capacidade e lifecycle acoplado.                                                          | [#124](https://github.com/niraldojunior/nexus/issues/124)                                                            | [#154](https://github.com/niraldojunior/nexus/issues/154)                                                            |
| **REQ-MOD03-008** | Parcial    | `supportingResource` é validado, persistido e filtrável; CFS direto é rejeitado.                  | Reverse impact completo, papéis, cardinalidades, reação a eventos Resource e o trace composto até o ativo civil (RF-005/RF-006). | [#127](https://github.com/niraldojunior/nexus/issues/127)                                                            | [#154](https://github.com/niraldojunior/nexus/issues/154), [#144](https://github.com/niraldojunior/nexus/issues/144) |
| **REQ-MOD03-009** | Parcial    | `supportingService` valida existência e tipo RFS.                                                 | Detecção de ciclos, expansão da árvore, compartilhamento e propagação de estado.                                                 | [#124](https://github.com/niraldojunior/nexus/issues/124), [#126](https://github.com/niraldojunior/nexus/issues/126) | [#154](https://github.com/niraldojunior/nexus/issues/154)                                                            |
| **REQ-MOD03-010** | Parcial    | `place` é persistido, validado e filtrável com múltiplos papéis.                                  | Semântica A/Z, re-home, cobertura e validação geográfica avançada.                                                               | —                                                                                                                    | [#152](https://github.com/niraldojunior/nexus/issues/152)                                                            |
| **REQ-MOD03-011** | Parcial    | SubscriberID é obrigatório no CFS e possui filtro dedicado.                                       | Geração Nexus-native, unicidade, faixa, autoridade e convivência legado.                                                         | [#123](https://github.com/niraldojunior/nexus/issues/123)                                                            | [#153](https://github.com/niraldojunior/nexus/issues/153)                                                            |
| **REQ-MOD03-012** | Parcial    | O modelo genérico e a UI suportam CFS Bitstream sobre RFS/Resources GPON.                         | Specs canônicas, perfil, VLANs, granularidade do RFS e aceite end-to-end.                                                        | [#122](https://github.com/niraldojunior/nexus/issues/122), [#124](https://github.com/niraldojunior/nexus/issues/124) | [#155](https://github.com/niraldojunior/nexus/issues/155)                                                            |
| **REQ-MOD03-013** | Parcial    | O modelo suporta CFS multiponto, RFS encadeados, VRF/IP e places A/Z.                             | Catálogo EILD/L2/L3VPN, SLA, regras multiponto e cenário automatizado.                                                           | [#122](https://github.com/niraldojunior/nexus/issues/122)                                                            | [#155](https://github.com/niraldojunior/nexus/issues/155)                                                            |
| **REQ-MOD03-014** | Parcial    | `serviceRelationship` e LogicalResource E.164 permitem representar CloudVoIP.                     | Catálogo VoIP, bundle/dependência, características e aceite end-to-end.                                                          | [#122](https://github.com/niraldojunior/nexus/issues/122), [#125](https://github.com/niraldojunior/nexus/issues/125) | [#155](https://github.com/niraldojunior/nexus/issues/155)                                                            |
| **REQ-MOD03-015** | Divergente | Relações têm CRUD, mas `ServiceService` aceita qualquer string e não consulta catálogo governado. | Bootstrap + CRUD de RelationshipType, validação, inversos, Audit e evento.                                                       | [#125](https://github.com/niraldojunior/nexus/issues/125)                                                            | [#156](https://github.com/niraldojunior/nexus/issues/156)                                                            |
| **REQ-MOD03-016** | Parcial    | Eventos de catálogo/inventário são persistidos, consultáveis por TMF688 e testados.               | Outbox, Schema Registry, catálogo, DLQ, reprocessamento e UUID v7.                                                               | —                                                                                                                    | [#158](https://github.com/niraldojunior/nexus/issues/158)                                                            |
...
- CFS sendo criado. Estratégia de geração de SubscriberID definida ([#123](https://github.com/niraldojunior/nexus/issues/123)).
...
`tipo:decisão` e `mod:service`:
[github.com/niraldojunior/nexus/issues?q=is:open+label:mod:service](https://github.com/niraldojunior/nexus/issues?q=is%3Aopen+label%3Amod%3Aservice).
