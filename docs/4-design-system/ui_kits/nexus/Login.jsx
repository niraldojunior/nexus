    ...
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', height: '100%' }}>
      ...
      >
        ...
        <div style={{ position: 'relative' }}>
          ...
          >
            Inventário de Redes da V.tal — Geosite, Logradouros, Geonet e Viabilidade Fuzzy
            unificados sob arquitetura modular, API-first e padrão TM Forum.
          </p>
      ...
      >
        <div style={{ width: '100%', maxWidth: 360 }}>
          <div style={{ font: 'var(--text-h2)', letterSpacing: '-0.02em', marginBottom: 4 }}>
            Acessar a plataforma
          </div>
          <p style={{ fontSize: 13.5, color: 'var(--text-tertiary)', marginBottom: 28 }}>
          ...
          >
            ...
            <span style={{ fontSize: 12, color: 'var(--text-tertiary)' }}>
              Conexão segura · SSO corporativo V.tal
            </span>
          </div>
        </div>
      </div>
