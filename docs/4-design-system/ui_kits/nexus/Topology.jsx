          ...
          >
            <div>
              ...
              <div style={{ fontSize: 12, color: 'var(--text-tertiary)' }}>
                OLT → Cliente · 5 elementos · 4,2 km
              </div>
            </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--gap-card)' }}>
        <Card pad={0} style={{ overflow: 'hidden' }}>
              ...
              >
                ...
                <span
                  style={{
                    ...
                    textAlign: 'right',
                    fontFamily:
                      k === 'Coordenadas' || k === 'Recurso TMF' ? 'var(--font-mono)' : 'inherit',
                  }}
                >
                  {v}
                </span>
          ...
          <div style={{ padding: 16, display: 'flex', gap: 10 }}>
            ...
            <Button
              ...
              size="sm"
              fullWidth
              iconLeft={<Icon name="code" size={14} />}
            >
              API
            </Button>
          </div>
        ...
        <Card style={{ background: 'var(--vt-ink)', border: 'none' }}>
          ...
          <p style={{ fontSize: 12.5, color: 'rgba(255,255,255,0.6)', lineHeight: 1.5 }}>
            Este recurso é exposto via Open API TMF639 e reconciliado a cada 15 min.
          </p>
          <div
            style={{
              marginTop: 12,
