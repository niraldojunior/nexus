    ...
    >
      ...
      <Card pad={24} style={{ height: 'fit-content' }}>
        ...
        <p style={{ fontSize: 13, color: 'var(--text-tertiary)', marginBottom: 20 }}>
          Consulta fuzzy por endereço, coordenada ou CEP — evoluído do Viabilidade Fuzzy.
        </p>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          <Input
            label="Endereço ou coordenada"
          ...
          <Button
            variant="primary"
            fullWidth
            iconLeft={<Icon name="radar" size={16} />}
        ...
        <div style={{ marginTop: 22, borderTop: '1px solid var(--border)', paddingTop: 16 }}>
          <div className="vt-eyebrow" style={{ marginBottom: 10 }}>
            Consultas recentes
          </div>
          ...
          <Card pad={0} style={{ overflow: 'hidden' }}>
            ...
            <div style={{ padding: 24 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 12 }}>
                <Fact
                  icon="ruler"
                  label="Distância ao CTO mais próximo"
              ...
              <div style={{ display: 'flex', gap: 10, marginTop: 22 }}>
                <Button
                  variant="primary"
                  iconLeft={<Icon name="file-plus-2" size={15} />}
                  disabled={result.status === 'inviavel'}
                >
                  Gerar ordem de serviço
                </Button>
                <Button variant="secondary" iconLeft={<Icon name="share-2" size={15} />}>
                  Ver na topologia
                </Button>
              </div>
            </div>
