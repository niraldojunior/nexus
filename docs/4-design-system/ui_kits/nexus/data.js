...
window.NexusData = (function () {
  ...
  const geo = {
    ...
    addresses: [
      {
        id: 'addr-rj-bot-320',
        main: 'Rua Voluntários da Pátria, 320',
        city: 'Rio de Janeiro/RJ',
        quality: 'Validado',
        location: 'loc-rj-bot-co-01',
        refs: 1,
      },
      {
        id: 'addr-sp-cas-1820',
        main: 'Av. Casa Verde, 1820',
        city: 'São Paulo/SP',
        quality: 'Validado',
        location: 'loc-sp-cas-pop-03',
        refs: 2,
      },
      {
        id: 'addr-sp-pujol-500',
        main: 'Rua Alfredo Pujol, 500',
        city: 'São Paulo/SP',
        quality: 'Geocodificar',
        location: 'Pendente',
        refs: 1,
      },
    ],
    locations: [
      ...
      {
        id: 'loc-cov-sp-norte',
        name: 'Cobertura SP Norte',
        geometry: 'MultiPolygon',
        spatialRef: 'EPSG:4326',
        refs: 'Viabilidade',
      },
      {
        id: 'loc-rota-marginal-0912',
        name: 'Eixo Marginal Tietê',
        geometry: 'LineString',
        spatialRef: 'EPSG:4326',
        refs: 'Cabo',
      },
    ...
    relationships: [
      ...
      {
        from: 'POP Casa Verde',
        to: 'Armário Santana 044',
        type: 'feeds',
        impact: '42 CTOs na área',
      },
      {
        from: 'POP Casa Verde',
        to: 'POPs de Borda Sudeste',
        type: 'memberOf',
        impact: 'Grupo funcional',
      },
    ],
  };
