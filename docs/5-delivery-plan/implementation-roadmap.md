...
> Fonte: AGENTS.md, README.md, `docs/1-overview`, HLDs MOD01-MOD03, `docs/3-system-design` e `docs/4-design-system`.
...
O detalhamento das APIs do backend está consolidado em `docs/5-delivery-plan/backend-api-plan.md`.
...
| INC-003 | Overview marca MOD03 como "Não iniciado", mas `03-module-service.md` existe e cobre REQ-MOD03-001 a 016. | Roadmap e status executivo ficam defasados. | Considerar MOD03 como "Em elaboração" neste plano. |
