...
| R-007 | Governança completa de Party/Tenant atrasada.                             |       Alta |         Média | Multi-tenancy e Service ficam parcialmente validados.                                                                   | Usar D-SVC-003 apenas no MVP e concluir DEV-X-004/DEV-SVC-003.                             | Produto + BSS            |
...
| R-018 | Divergência entre o modelo Postgres atual e o alvo Oracle/Property Graph. |      Média |         Média | Bugs aparecem tarde em constraints, índices, tipos, paginação, filtros ou grafo.                                        | Isolar repositórios, versionar migrations e executar DEV-X-005 com suíte compartilhada.    | Engenharia               |
