...
| DEV-RES-007 | P0 | Pendente | REQ-MOD02-026, seus RF/CA | Infraestrutura subterrânea modelada como banco de dutos, duto e sub-duto, com endpoints A/Z em estruturas reais, ocupação derivada e consulta de cabos por trecho. | TMF639 Outside Plant e contenção de recursos | Q-RES-014, DEV-RES-002, DEV-RES-006 | O backend representa duto como PhysicalResource plano; não existe contenção banco→duto→sub-duto, endpoints A/Z nem ocupação derivada. | Banco de 4 vias entre duas caixas aceita 2 cabos, deriva o trecho A↔Z sem entidade intermediária, rejeita duto sem endpoint (422) e 5º cabo em duto de 4 vias (409). |
