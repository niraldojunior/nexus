...
export const RESOURCE_TYPES: ResourceType[] = [
  ...
  // Novos tipos canônicos de infraestrutura e telecom (Taxonomia Master V.tal)
  ...
  resourceType('rt-ont-port', 'ONTPort', 'Porta ONT', 'Equipment.CustomerPremises'),
  resourceType('rt-pon-logical', 'PONLogical', 'PON Lógica', 'Logical.Telecom.Access.GPON'),
  resourceType('rt-ont-id', 'ONTID', 'ONT ID', 'Logical.Telecom.Access.GPON'),
  resourceType('rt-gem-port', 'GEMPort', 'GEM Port', 'Logical.Telecom.Access.GPON'),
  resourceType('rt-ups', 'UPS', 'UPS (No-Break)', 'Equipment.EnergyFacilities'),
