...
export default function GmailMark({ className = '' }: GmailMarkProps) {
  return (
    ...
    >
      <path
        d="M4.5 7.2L12 12.8L19.5 7.2V17.5C19.5 18.1 19.1 18.5 18.5 18.5H5.5C4.9 18.5 4.5 18.1 4.5 17.5V7.2Z"
        fill="#EA4335"
      />
      ...
      <path
        d="M4.5 7.2L11.2 12.1C11.67 12.44 12.33 12.44 12.8 12.1L19.5 7.2L18.55 5.8C18.27 5.39 17.8 5.14 17.3 5.14H6.7C6.2 5.14 5.73 5.39 5.45 5.8L4.5 7.2Z"
        fill="#FBBC04"
      />
