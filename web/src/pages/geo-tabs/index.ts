...
export { ResourceConnectionsTab, type ResourceConnectionsTabProps } from './ResourceConnectionsTab';
export { ResourceComponentsTab, type ResourceComponentsTabProps } from './ResourceComponentsTab';
